...
namespace AetherialArena.Windows
{
    public class AboutWindow : Window, IDisposable
    {
        ...
        public AboutWindow(Plugin p) : base("About Aetherial Arena")
        {
            this.plugin = p;
            this.Size = new Vector2(400, 270);
        ...
        public override void Draw()
        {
            ...
            ImGui.Text("Release Date: 6/24/2025");
            ImGui.Separator();
            ImGui.Spacing();
            ...
            ImGui.Text("AetherDraw, WDIGViewer and AetherBreaker.");
            ...
            {
                if (!string.IsNullOrEmpty(plugin.PluginManifest.RepoUrl))
                    Util.OpenLink($"{plugin.PluginManifest.RepoUrl}/issues");
            }
